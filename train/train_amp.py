...
def train(gpu, args):
    ...
    # an attempt to even fasten the ema update
    # _, ema_opt = amp.initialize([model.ema.target, model.ema.target_proj], model.ema.optimizer, opt_level="O1")
    # model.ema.optimizer = ema_opt
